    ...
    variants: {
        mask: {
            [PATTERN_BACKGROUND_MASK.Ellipse]:
                "[mask-image:radial-gradient(ellipse_at_center,transparent,black_90%)]",
            [PATTERN_BACKGROUND_MASK.EllipseTop]:
                "[mask-image:radial-gradient(ellipse_at_top,transparent,black_80%)]",
            [PATTERN_BACKGROUND_MASK.EllipseRight]:
                "[mask-image:radial-gradient(ellipse_at_left,transparent,black_95%)]",
        },
    },
    defaultVariants: {
        mask: "ellipse",
